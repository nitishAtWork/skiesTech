...
function CatKeywordInCitySec(props) {
    return (
            ...
            <div className='container'>
                ...
                <div className=" mt-4">
                    <div className="abt-floated">
                        <img className='w-100' src={process.env.REACT_APP_BASE_URL+"images/categories/"+props.data.img} alt={props.data.shortDescription} title={props.data.shortDescription} />
                    </div>
...
export default CatKeywordInCitySec