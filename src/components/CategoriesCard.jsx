  ...
  return (
    <motion.div
      ...
      <div className='service-img'>
        <img className='w-100' loading='lazy' src={process.env.REACT_APP_BASE_URL + "images/categories/" + props.servImg} alt={props.productName} title={props.productName} />
      </div>
      ...
      <div className='service-name-box'>
        <div className='service-content'>
          ...
          <BtnLink  Href={props.Href} btnName="View Details" />
        </div>
      </div>
